      ...
      <div className="page-layout">
        ...
        <div className="content">
          <div className="section">
            <p>
              Je n'ai jamais été spécialement doué pour les remerciemenents, mais comme il faut bien
              ...
              d'autre je pense) à prendre confiance en moi et mettre de côté le syndrome de
              l'imposteur.
            </p>
            <p>
              Plus généralement je remercierait l'ESD, qui m'a permis de découvrir et approfondir
              des sujets qui me pasionnent. J'ai passé 5 années excellentes, des moments plus ou
              moins compliqués, de doute ou de remise en question, mais toujours en avançant dans la
              bonne direction.
            </p>
            <p>
              Je sais maintenant que je pourrais travailler dans un domaine qui me passionne et j'en
